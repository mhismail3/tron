...
command ID. The helper rotates that file to `deploy.jsonl.1` above 1 MB at operation start; log
failures never affect a deployment. The mutation is usable only when the helper is
