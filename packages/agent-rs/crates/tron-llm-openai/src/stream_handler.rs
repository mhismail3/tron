...
use tron_llm::{parse_tool_call_arguments, ToolCallContext};

use crate::types::ResponsesSseEvent;
...
fn merge_completed_output_items(
    response: &crate::types::ResponsesResponse,
    state: &mut StreamState,
...
fn merge_message_item(item: &crate::types::ResponsesOutputItem, state: &mut StreamState) {
...
fn merge_reasoning_item(
    item: &crate::types::ResponsesOutputItem,
    state: &mut StreamState,
    events: &mut Vec<StreamEvent>,
) {
...
fn merge_function_call_item(item: &crate::types::ResponsesOutputItem, state: &mut StreamState) {
...
mod tests {
    use super::*;
    use crate::types::{OutputContent, ResponsesOutputItem, ResponsesResponse, ResponsesUsage};
