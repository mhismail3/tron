...
fn rust_worker_kernel_keeps_composition_root_thin() {
    let required = [
        ...
        "packages/agent/src/domains/worker_kernel/persistence/store/lifecycle.rs",
        "packages/agent/src/domains/worker_kernel/persistence/store/publication.rs",
        "packages/agent/src/domains/worker_kernel/persistence/store/state.rs",
        "packages/agent/src/domains/worker_kernel/persistence/store/triggers.rs",
        "packages/agent/src/domains/worker_kernel/runtime/mod.rs",
        "packages/agent/src/domains/worker_kernel/runtime/activation.rs",
        "packages/agent/src/domains/worker_kernel/runtime/dispatch.rs",
        "packages/agent/src/domains/worker_kernel/runtime/invocation.rs",
        "packages/agent/src/domains/worker_kernel/runtime/lifecycle.rs",
        "packages/agent/src/domains/worker_kernel/runtime/resident.rs",
        "packages/agent/src/domains/worker_kernel/runtime/secrets.rs",
