...
fn hyper_modular_architecture_plan_stays_formalized() {
    ...
    for required in [
        ...
        "| HMH-G | Final adversarial closeout and absence gates | 10 | passed |",
        ...
        "| HMH-G4 | Live recursive loop rerun | 20 | passed |",
        ...
        "8 passed; 0 failed; 0 ignored; 0 measured; 82 filtered out;",
        "finished in 91.81s",
        "unique_event_store()",
        "unique_settings_path()",
        "EngineHostHandle::new_in_memory()",
        "boot_server_without_deps_with_config",
        "boot_server_with_provider_config_and_handles",
        "capability_self_modifying_lifecycle_execute_returns_worker_protocol_guide",
        "capability_self_modifying_lifecycle_spawns_session_worker",
        "capability_self_modifying_lifecycle_inspects_session_worker_catalog",
        "capability_self_modifying_lifecycle_records_session_worker_conformance_evidence",
        "capability_self_modifying_lifecycle_invokes_session_worker_through_execute",
        "capability_self_modifying_lifecycle_governs_session_worker_promotion",
        "capability_self_modifying_lifecycle_cleans_up_session_worker_and_stale_calls_fail_closed",
        ...
        "| HMH-G6 | Diff hygiene and dead-code scan | 10 | passed_after_fix |",
        "HMH-G6 evidence, 2026-06-03:",
        "AnyCodable rewrap cleanup",
        "git diff --check origin/next/modular-capability-engine...HEAD",
        ...
        "14 tests in 1 suite passed",
        "production-source added-line scans",
        "Open loops after HMH-G1/HMH-G2/HMH-G3/HMH-G4/HMH-G5/HMH-G6:",
        "Continue with HMH-G7: update the ledger",
        "| HMH-G7 | Ledger and final status are honest | 10 | passed |",
        "HMH-G7 evidence, 2026-06-03:",
        "f32a6f61-b08e-49c9-af95-134539311964",
        "Final status honesty",
        "All HMH rows are closed",
        "No active Next Test remains",
        "## Final Status",
        "The hyper modular agent harness execution portfolio is complete.",
    ...
    for forbidden in [
        ...
        "| HMH-G6 | Diff hygiene and dead-code scan | 10 | pending |",
        "| HMH-G7 | Ledger and final status are honest | 10 | pending |",
