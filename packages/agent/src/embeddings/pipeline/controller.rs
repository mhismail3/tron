...
use crate::embeddings::errors::{EmbeddingError, Result};
use crate::embeddings::hybrid::{HybridResult, HybridSearchOptions, reciprocal_rank_fusion};
use crate::embeddings::service::EmbeddingService;
use crate::embeddings::text::{
    build_embedding_text_from_json, build_lesson_texts, with_document_prefix, with_query_prefix,
};
use crate::embeddings::vector_repo::{SearchOptions, VectorRepository, VectorSearchResult};
...
mod tests {
    use super::*;
    use crate::embeddings::service::MockEmbeddingService;
    use crate::embeddings::vector_repo::VectorRepository;
