...
use crate::server::platform::device_broker::DeviceRequestBroker;
...
pub struct ServerRuntimeContext {
    ...
    /// [`crate::server::updater::MockReleaseFetcher`] so transport tests can
...
mod tests {
    use super::*;
    use crate::server::shared::test_support::{
