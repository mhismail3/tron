...
mod tests {
    ...
    fn make_context_with_worktree(
        ...
        let home = crate::server::services::test_support::unique_tron_home();
        let settings_path = crate::server::services::test_support::test_user_profile_path(&home);
        let profile_runtime = crate::server::services::test_support::test_profile_runtime(&home);
        let auth_path = crate::server::services::test_support::test_auth_path(&home);
