...
fn skill_activate_value(params: Option<&Value>, deps: &Deps) -> Result<Value, CapabilityError> {
    ...
    let already_active = crate::server::domains::skills::state::reconstruct_tracker(
        &deps.event_store,
        &session_id,
...
fn skill_deactivate_value(params: Option<&Value>, deps: &Deps) -> Result<Value, CapabilityError> {
    ...
    let is_active = crate::server::domains::skills::state::reconstruct_tracker(
        &deps.event_store,
        &session_id,
        &crate::settings::types::CompactionPolicy::ClearAll,
    )
...
fn skill_active_value(params: Option<&Value>, deps: &Deps) -> Result<Value, CapabilityError> {
    ...
    let tracker = crate::server::domains::skills::state::reconstruct_tracker(
        &deps.event_store,
        &session_id,
        &crate::settings::types::CompactionPolicy::ClearAll,
    );
