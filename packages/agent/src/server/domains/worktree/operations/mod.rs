...
fn require_session_working_dir(deps: &Deps, session_id: &str) -> Result<String, CapabilityError> {
    let session = deps
        .session_manager
...
fn resolve_diff_dir(deps: &Deps, session_id: &str) -> Result<String, CapabilityError> {
