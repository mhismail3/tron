...
use crate::engine::{EngineQueueDrainer, EnqueueInvocation, FunctionId, Invocation};
...
pub(super) async fn prompt_value(
...
pub(super) async fn prompt_apply_value(
    params: Option<&Value>,
    invocation: &Invocation,
    deps: &Deps,
) -> Result<Value, CapabilityError> {
...
pub(super) async fn run_turn_value(
    params: Option<&Value>,
    invocation: &Invocation,
    deps: &Deps,
) -> Result<Value, CapabilityError> {
...
pub(super) async fn prompt_queue_drain_value(
    params: Option<&Value>,
    invocation: &Invocation,
    deps: &Deps,
) -> Result<Value, CapabilityError> {
...
pub(super) fn validate_attachment_arrays(
    images: Option<&[Value]>,
...
pub(super) async fn enqueue_and_sync_drain_agent_function(
    invocation: &Invocation,
    deps: &Deps,
    session_id: &str,
    function_id: &str,
...
pub(super) fn record_prompt_history(deps: &Deps, prompt: &str, source: Option<&str>) {
    let is_cron = source
...
pub(super) async fn publish_prompt_stream(
    invocation: &Invocation,
    deps: &Deps,
    session_id: &str,
    action: &str,
...
pub(super) async fn status_value(
    params: Option<&Value>,
    deps: &Deps,
) -> Result<Value, CapabilityError> {
    let session_id = require_string_param(params, "sessionId")?;
...
pub(super) async fn abort_value(
    params: Option<&Value>,
    deps: &Deps,
) -> Result<Value, CapabilityError> {
    let session_id = require_string_param(params, "sessionId")?;
...
pub(super) async fn abort_tool_value(
    params: Option<&Value>,
    deps: &Deps,
) -> Result<Value, CapabilityError> {
    let session_id = require_string_param(params, "sessionId")?;
...
pub(super) async fn queue_prompt_value(
    params: Option<&Value>,
    invocation: &Invocation,
    deps: &Deps,
) -> Result<Value, CapabilityError> {
...
pub(super) async fn dequeue_prompt_value(
    params: Option<&Value>,
    invocation: &Invocation,
    deps: &Deps,
) -> Result<Value, CapabilityError> {
...
pub(super) async fn clear_queue_value(
    params: Option<&Value>,
    invocation: &Invocation,
    deps: &Deps,
) -> Result<Value, CapabilityError> {
...
pub(super) async fn submit_confirmation_value(
    params: Option<&Value>,
    deps: &Deps,
) -> Result<Value, CapabilityError> {
    let session_id = require_string_param(params, "sessionId")?;
...
pub(super) async fn submit_answers_value(
    params: Option<&Value>,
    deps: &Deps,
) -> Result<Value, CapabilityError> {
    let session_id = require_string_param(params, "sessionId")?;
...
pub(super) async fn deliver_subagent_results_value(
    params: Option<&Value>,
    deps: &Deps,
) -> Result<Value, CapabilityError> {
    let session_id = require_string_param(params, "sessionId")?;
...
pub(super) async fn start_or_queue_prompt(
    deps: &Deps,
    session_id: String,
    prompt: String,
...
pub(super) async fn start_or_queue_prompt_with_loaded_session(
    deps: &Deps,
...
pub(super) async fn load_prompt_session(
    deps: &Deps,
    session_id: &str,
    task: &'static str,
...
pub(super) async fn publish_agent_queue_stream(
    invocation: &Invocation,
    deps: &Deps,
    session_id: &str,
    action: &str,
