...
pub(super) struct PromptContextBundle {
    ...
    pub(super) rules_index: Option<crate::runtime::context::rules_index::RulesIndex>,
...
impl PromptContextBundle {
    pub(super) fn volatile_tokens(
        ...
        context_policy: &crate::runtime::context::local_policy::ContextPolicy,
    ) -> VolatileTokens {
...
pub(super) async fn load_prompt_context_bundle(
    ...
    resolved_profile: &Arc<crate::core::profile::ResolvedProfile>,
) -> PromptContextBundle {
...
fn load_memory_context(
    ...
    Some(
        registry
            .content(&crate::core::paths::home_dir())
            .to_string(),
    )
}
