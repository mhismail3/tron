...
use crate::server::domains::context::queries::prepare_session_context;
use crate::server::domains::context::service::build_summarizer;
    ...
    pub(crate) async fn clear(deps: &Deps, session_id: String) -> Result<Value, CapabilityError> {
        ...
        let _ = run_blocking_task("context.clear.persist", move || {
            let _ = event_store.append(&crate::events::AppendOptions {
                ...
                event_type: crate::events::EventType::ContextCleared,
                payload: json!({
        ...
        let _ =
            deps.orchestrator
                .broadcast()
                .emit(crate::core::events::TronEvent::ContextCleared {
...
async fn execute_compaction(
    ...
    let _ = deps
        .orchestrator
        .broadcast()
        .emit(crate::core::events::TronEvent::CompactionStart {
            base: crate::core::events::BaseEvent::now(&session_id),
            reason: crate::core::events::CompactionReason::Manual,
            tokens_before,
        });
    ...
    let _ =
        deps.orchestrator
            .broadcast()
            .emit(crate::core::events::TronEvent::CompactionComplete {
                base: crate::core::events::BaseEvent::now(&session_id),
                success: result.success,
                tokens_before: result.tokens_before,
                tokens_after: result.tokens_after,
                compression_ratio: result.compression_ratio,
                reason: Some(crate::core::events::CompactionReason::Manual),
