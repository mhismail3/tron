...
macro_rules! operation_bindings {
    (
        ...
        fn operation_bindings() -> Vec<$crate::server::domains::bindings::OperationBinding<$deps_ty>> {
            vec![
                $(
                    $crate::server::domains::bindings::OperationBinding::new(
                        $operation_key,
    ...
    (
        ...
        pub(crate) fn handler_for_operation(
            ...
            $crate::server::domains::bindings::handler_for_operation(
...
mod tests {
    ...
    fn spec(operation_key: &'static str) -> crate::server::domains::catalog::CapabilitySpec {
