...
pub(super) async fn cron_list_value(
    payload: &Value,
    deps: &Deps,
...
pub(super) async fn cron_get_value(payload: &Value, deps: &Deps) -> Result<Value, CapabilityError> {
    let sched = scheduler(deps)?;
...
pub(super) async fn cron_create_value(
    payload: &Value,
...
pub(super) async fn cron_update_value(
    payload: &Value,
    invocation: &Invocation,
    deps: &Deps,
) -> Result<Value, CapabilityError> {
...
pub(super) async fn cron_delete_value(
    payload: &Value,
    invocation: &Invocation,
    deps: &Deps,
) -> Result<Value, CapabilityError> {
...
pub(super) async fn cron_run_value(
    payload: &Value,
    invocation: &Invocation,
    deps: &Deps,
) -> Result<Value, CapabilityError> {
...
pub(super) async fn cron_scheduled_fire_value(
    payload: &Value,
    invocation: &Invocation,
    deps: &Deps,
) -> Result<Value, CapabilityError> {
...
pub(super) async fn cron_status_value(deps: &Deps) -> Result<Value, CapabilityError> {
    let sched = scheduler(deps)?;
    Ok(json!({
        "running": true,
...
pub(super) async fn cron_get_runs_value(
    payload: &Value,
    deps: &Deps,
) -> Result<Value, CapabilityError> {
    let sched = scheduler(deps)?;
