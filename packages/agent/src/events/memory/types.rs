...
impl From<&crate::settings::CompactorSettings> for CompactionTriggerConfig {
    fn from(cs: &crate::settings::CompactorSettings) -> Self {
...
///
/// Passed to [`MemoryManager::on_cycle_complete`](crate::events::manager::MemoryManager::on_cycle_complete)
...
mod tests {
    use super::*;
    use crate::settings::CompactorSettings;
