...
use crate::runtime::guardrails::types::{EvaluationContext, RuleEvaluationResult};
            ...
            if arg_name == "command" {
                if self.check_bash_command_for_paths(value, &homedir) {
                    ...
                    .with_details(serde_json::json!({
                        "command": crate::core::text::truncate_str(value, 200)
                    }));
                }
                ...
                if self.block_hidden && has_hidden_mkdir(value) {
                    ...
                    .with_details(
                        serde_json::json!({ "command": crate::core::text::truncate_str(value, 200) }),
                    );
                }
                continue;
            }
...
mod tests {
    ...
    fn make_path_rule(protected: Vec<String>) -> PathRule {
        ...
        use crate::runtime::guardrails::types::Severity;
        PathRule {
            base: RuleBase {
                id: "test".into(),
                name: "test".into(),
