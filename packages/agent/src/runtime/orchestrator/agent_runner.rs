...
use crate::runtime::agent::tron_agent::TronAgent;
use crate::runtime::types::{RunContext, RunResult};
...
mod tests {
    ...
    struct MockProvider;
    #[async_trait]
    impl crate::llm::provider::Provider for MockProvider {
    ...
    async fn run_agent_error_still_emits_ready() {
        ...
        #[async_trait]
        impl crate::llm::provider::Provider for ErrorProvider {
            fn provider_type(&self) -> Provider {
                Provider::Anthropic
            }
            fn model(&self) -> &'static str {
    ...
    async fn forward_task_drains_all_events() {
        ...
        #[async_trait]
        impl crate::llm::provider::Provider for MultiEventProvider {
            fn provider_type(&self) -> Provider {
                Provider::Anthropic
            }
            fn model(&self) -> &'static str {
