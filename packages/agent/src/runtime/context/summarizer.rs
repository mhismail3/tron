...
fn cap_transcript(text: &str, max_chars: usize) -> String {
    ...
    let head = crate::core::text::truncate_str(text, quarter);
...
fn truncate(s: &str, max_len: usize) -> String {
    crate::core::text::truncate_with_suffix(s, max_len, "...")
}
...
mod tests {
    ...
    fn tool_result_content_text_from_blocks() {
        let content = ToolResultMessageContent::Blocks(vec![
            crate::core::content::ToolResultContent::text("line1"),
            crate::core::content::ToolResultContent::text("line2"),
        ]);
