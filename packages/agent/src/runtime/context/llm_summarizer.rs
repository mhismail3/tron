...
//!
//! Uses [`serialize_messages`](crate::runtime::summarizer::serialize_messages) and
//! [`parse_summarizer_response`](crate::runtime::summarizer::parse_summarizer_response)
...
mod tests {
    ...
    use crate::runtime::context::constants::{
