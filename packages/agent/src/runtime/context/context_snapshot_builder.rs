    ...
    match msg {
        Message::User { content, .. } => {
            let text = match content {
                crate::core::messages::UserMessageContent::Text(t) => t.clone(),
                crate::core::messages::UserMessageContent::Blocks(blocks) => blocks
                    .iter()
        ...
        Message::ToolResult {
            ...
            let text = match content {
                crate::core::messages::ToolResultMessageContent::Text(t) => t.clone(),
...
fn summarize_content(text: &str, max_len: usize) -> String {
    crate::core::text::truncate_with_suffix(text, max_len, "...")
}
...
mod tests {
    use super::*;
    use crate::core::messages::{ToolResultMessageContent, UserMessageContent};
