...
use crate::tools::traits::{BrowserAction, BrowserDelegate, BrowserResult};
...
mod integration_tests {
    ...
    fn make_delegate() -> CdpBrowserDelegate {
        let chrome = crate::tools::cdp::chrome::find_chrome().expect("Chrome required");
        let svc = Arc::new(crate::tools::cdp::service::BrowserService::new(chrome));
