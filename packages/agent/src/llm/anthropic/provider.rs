...
mod tests {
    use super::*;
    use crate::llm::anthropic::types::AnthropicProviderSettings;
    use crate::llm::provider::AnthropicEffortLevel;
    ...
    // ── API error parsing (via shared crate::llm::error_parsing) ────────────
