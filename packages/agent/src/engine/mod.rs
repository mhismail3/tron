...
pub use durability::resources::{
    ...
    MODULE_INSTALL_REQUEST_SCHEMA_ID, MODULE_MANIFEST_KIND, MODULE_MANIFEST_SCHEMA_ID,
    MODULE_PROPOSAL_KIND, MODULE_PROPOSAL_SCHEMA_ID, MODULE_VALIDATION_REPORT_KIND,
    ...
    UpdateResource, WEB_ROBOTS_POLICY_KIND, WEB_ROBOTS_POLICY_SCHEMA_ID, WEB_SOURCE_KIND,
    WEB_SOURCE_SCHEMA_ID,
};
