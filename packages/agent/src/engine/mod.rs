...
pub use durability::resources::{
    ...
    MODULE_MANIFEST_KIND, MODULE_MANIFEST_SCHEMA_ID, MODULE_PROPOSAL_KIND,
    MODULE_PROPOSAL_SCHEMA_ID, NOTIFICATION_DELIVERY_KIND, NOTIFICATION_DELIVERY_SCHEMA_ID,
    NOTIFICATION_KIND, NOTIFICATION_SCHEMA_ID, PROCEDURAL_RECORD_KIND, PROCEDURAL_RECORD_SCHEMA_ID,
