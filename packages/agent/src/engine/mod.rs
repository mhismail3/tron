...
pub(crate) use durability::resources::CAPABILITY_BINDING_POLICY_PAYLOAD_SCHEMA_VERSION;
pub(crate) use durability::resources::CAPABILITY_BINDING_REQUEST_PAYLOAD_SCHEMA_VERSION;
pub(crate) use durability::resources::CAPABILITY_REPLACEMENT_CANDIDATE_PAYLOAD_SCHEMA_VERSION;
pub(crate) use durability::resources::CAPABILITY_ROUTE_ACTIVATION_PAYLOAD_SCHEMA_VERSION;
pub(crate) use durability::resources::CAPABILITY_ROUTE_BINDING_PAYLOAD_SCHEMA_VERSION;
pub(crate) use durability::resources::CAPABILITY_ROUTE_EVENT_PAYLOAD_SCHEMA_VERSION;
pub(crate) use durability::resources::CAPABILITY_ROUTE_ROLLBACK_PAYLOAD_SCHEMA_VERSION;
pub(crate) use durability::resources::CAPABILITY_SHADOW_TRIAL_DECISION_PAYLOAD_SCHEMA_VERSION;
pub(crate) use durability::resources::CAPABILITY_SHADOW_TRIAL_EVIDENCE_PAYLOAD_SCHEMA_VERSION;
pub(crate) use durability::resources::CAPABILITY_SHADOW_TRIAL_REQUEST_PAYLOAD_SCHEMA_VERSION;
pub(crate) use durability::resources::CAPABILITY_SHADOW_TRIAL_RUN_PAYLOAD_SCHEMA_VERSION;
...
pub(crate) use durability::resources::WEB_RESEARCH_REQUEST_PAYLOAD_SCHEMA_VERSION;
pub(crate) use durability::resources::WEB_RESEARCH_REVIEW_PAYLOAD_SCHEMA_VERSION;
pub(crate) use durability::resources::WEB_RESEARCH_SOURCE_PAYLOAD_SCHEMA_VERSION;
#[cfg(test)]
...
pub use durability::resources::{
    ...
    APPROVAL_REQUEST_SCHEMA_ID, CAPABILITY_BINDING_DECISION_KIND,
    CAPABILITY_BINDING_DECISION_SCHEMA_ID, CAPABILITY_BINDING_POLICY_KIND,
    CAPABILITY_BINDING_POLICY_SCHEMA_ID, CAPABILITY_BINDING_REQUEST_KIND,
    CAPABILITY_BINDING_REQUEST_SCHEMA_ID, CAPABILITY_REPLACEMENT_CANDIDATE_KIND,
    CAPABILITY_REPLACEMENT_CANDIDATE_SCHEMA_ID, CAPABILITY_ROUTE_ACTIVATION_KIND,
    CAPABILITY_ROUTE_ACTIVATION_SCHEMA_ID, CAPABILITY_ROUTE_BINDING_KIND,
    CAPABILITY_ROUTE_BINDING_SCHEMA_ID, CAPABILITY_ROUTE_EVENT_KIND,
    ...
    CAPABILITY_SHADOW_TRIAL_RUN_SCHEMA_ID, CATALOG_DISCOVERY_REPORT_KIND,
    CATALOG_DISCOVERY_REPORT_SCHEMA_ID, CONTEXT_CONTROL_ACTION_KIND,
    CONTEXT_CONTROL_ACTION_SCHEMA_ID, CONTEXT_CONTROL_EPOCH_KIND, CONTEXT_CONTROL_EPOCH_SCHEMA_ID,
    CONTEXT_CONTROL_SNAPSHOT_KIND, CONTEXT_CONTROL_SNAPSHOT_SCHEMA_ID, CreateResource,
    DEVICE_REGISTRATION_KIND, DEVICE_REGISTRATION_SCHEMA_ID, EngineResource, EngineResourceEvent,
    EngineResourceInspection, EngineResourceLink, EngineResourceLocation, EngineResourceScope,
    EngineResourceTypeDefinition, EngineResourceVersion, EngineResourceVersioningMode,
    GIT_BRANCH_START_KIND, GIT_BRANCH_START_SCHEMA_ID, GIT_COMMIT_KIND, GIT_COMMIT_SCHEMA_ID,
    GIT_INDEX_CHANGE_KIND, GIT_INDEX_CHANGE_SCHEMA_ID, GOAL_ANSWER_KIND, GOAL_ANSWER_SCHEMA_ID,
    IMPORT_HISTORY_RECORD_KIND, IMPORT_HISTORY_RECORD_SCHEMA_ID, IMPORT_PREVIEW_KIND,
    IMPORT_PREVIEW_SCHEMA_ID, JOB_PROCESS_KIND, JOB_PROCESS_SCHEMA_ID, LinkResources,
    ListResources, MEDIA_ARTIFACT_KIND, MEDIA_ARTIFACT_SCHEMA_ID, MEMORY_DECISION_KIND,
    MEMORY_DECISION_SCHEMA_ID, MEMORY_ENGINE_KIND, MEMORY_ENGINE_SCHEMA_ID, MEMORY_EVAL_RUN_KIND,
    MEMORY_EVAL_RUN_SCHEMA_ID, MEMORY_MIGRATION_ENVELOPE_KIND, MEMORY_MIGRATION_ENVELOPE_SCHEMA_ID,
    MEMORY_POLICY_KIND, MEMORY_POLICY_SCHEMA_ID, MEMORY_PROMPT_TRACE_KIND,
    MEMORY_PROMPT_TRACE_SCHEMA_ID, MEMORY_QUERY_KIND, MEMORY_QUERY_SCHEMA_ID, MEMORY_RECORD_KIND,
    MEMORY_RECORD_SCHEMA_ID, MODULE_DEPENDENCY_DECISION_KIND, MODULE_DEPENDENCY_DECISION_SCHEMA_ID,
    ...
    PROCEDURAL_RECORD_KIND, PROCEDURAL_RECORD_SCHEMA_ID, PROGRAM_EXECUTION_KIND,
    PROGRAM_EXECUTION_SCHEMA_ID, PROMPT_ARTIFACT_KIND, PROMPT_ARTIFACT_SCHEMA_ID,
    REPOSITORY_TREE_SNAPSHOT_KIND, REPOSITORY_TREE_SNAPSHOT_SCHEMA_ID, RegisterResourceType,
    SCHEDULE_KIND, SCHEDULE_RUN_KIND, SCHEDULE_RUN_SCHEMA_ID, SCHEDULE_SCHEMA_ID,
    SUBAGENT_TASK_KIND, SUBAGENT_TASK_SCHEMA_ID, TOOL_SOURCE_CONFORMANCE_REPORT_KIND,
    TOOL_SOURCE_CONFORMANCE_REPORT_SCHEMA_ID, TOOL_SOURCE_PROPOSAL_KIND,
    TOOL_SOURCE_PROPOSAL_SCHEMA_ID, UI_SURFACE_KIND, UPDATE_DIAGNOSTIC_RECORD_KIND,
    UPDATE_DIAGNOSTIC_RECORD_SCHEMA_ID, USER_QUESTION_KIND, USER_QUESTION_SCHEMA_ID,
    UpdateResource, WEB_RESEARCH_REQUEST_KIND, WEB_RESEARCH_REQUEST_SCHEMA_ID,
    WEB_RESEARCH_REVIEW_KIND, WEB_RESEARCH_REVIEW_SCHEMA_ID, WEB_RESEARCH_SOURCE_KIND,
    WEB_RESEARCH_SOURCE_SCHEMA_ID, WEB_ROBOTS_POLICY_KIND, WEB_ROBOTS_POLICY_SCHEMA_ID,
    WEB_SOURCE_KIND, WEB_SOURCE_SCHEMA_ID,
};
pub(crate) use durability::resources::{
