...
pub use durability::resources::{
    ...
    CONTEXT_CONTROL_SNAPSHOT_KIND, CONTEXT_CONTROL_SNAPSHOT_SCHEMA_ID, CONTEXT_EXCLUSION_KIND,
    CONTEXT_EXCLUSION_SCHEMA_ID, CONTEXT_POLICY_SNAPSHOT_KIND, CONTEXT_POLICY_SNAPSHOT_SCHEMA_ID,
    CONTEXT_SURVIVOR_KIND, CONTEXT_SURVIVOR_SCHEMA_ID, CreateResource, DEVICE_REGISTRATION_KIND,
    ...
    GIT_INDEX_CHANGE_SCHEMA_ID, GOAL_ANSWER_KIND, GOAL_ANSWER_SCHEMA_ID,
