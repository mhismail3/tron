...
use crate::app::onboarding::generate_bearer_token;
use crate::domains::settings::{
    CodexAppApprovalPolicy, CodexAppSandboxMode, CodexAppServerSettings,
};
...
impl CodexAppServerManager {
    ...
    pub fn new(settings: CodexAppServerSettings) -> io::Result<Self> {
        Self::with_deps(
            settings,
            crate::shared::paths::codex_app_server_token_path(),
