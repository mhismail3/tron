...
mod tests {
    ...
    fn execute_description_teaches_self_modifying_worker_lifecycle() {
        ...
        for required in [
            ...
            "Keep grant ids, trace ids, resource refs, catalog revision, child invocation ids, and function ids for Inspect",
        ] {
            assert!(
