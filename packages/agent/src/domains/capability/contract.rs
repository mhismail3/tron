...
mod tests {
    ...
    fn execute_schema_exposes_primitive_operations_not_catalog_targets() {
        ...
        assert!(description.contains(
            "built-in provider-safe projection until a supervised module adapter projection call is available"
        ));
