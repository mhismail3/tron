...
macro_rules! operation_bindings {
    (
        ...
        pub(crate) fn function_registrations(
            specs: Vec<$crate::domains::catalog::CapabilitySpec>,
            deps: Deps,
        ) -> $crate::engine::Result<Vec<$crate::domains::worker::DomainFunctionRegistration>> {
            $crate::domains::bindings::function_registrations(
                specs,
                deps,
                operation_bindings(),
                &[],
        ...
        fn operation_bindings() -> Vec<$crate::domains::bindings::OperationBinding<$deps_ty>> {
            vec![
                $(
                    $crate::domains::bindings::OperationBinding::new(
                        $operation_key,
    ...
    (
        ...
        pub(crate) fn handler_for_operation(
            ...
            $crate::domains::bindings::handler_for_operation(
...
mod tests {
    ...
    fn spec(operation_key: &'static str) -> crate::domains::catalog::CapabilitySpec {
