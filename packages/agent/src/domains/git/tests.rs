    ...
    let result = ctx
        ...
        .invoke(Invocation::new_sync(
            ...
            json!({
                ...
                "allowedAuthorityScopes": ["capability.execute", "git.read", "git.write", "resource.read", "resource.write"],
                "allowedResourceKinds": ["git_index_change", "git_commit", "git_branch_start"],
