...
//! IDs and timestamps.
//!
//! [`EventChainBuilder`] wraps an [`EventStore`](crate::domains::session::event_store::store::EventStore) and
...
///
/// Uses the [`EventStore`](crate::domains::session::event_store::store::EventStore) for persistence.
pub struct EventChainBuilder {
    store: crate::domains::session::event_store::store::EventStore,
    session_id: String,
    head: String,
}
