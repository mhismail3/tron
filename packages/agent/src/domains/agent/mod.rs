...
//! 10. `agent::work_snapshot` projects autonomy, active work, workers, trust,
//!     generated controls, recent milestones, guardrails, and audit refs from
//!     engine-owned settings, catalog, invocation, and approval primitives.
//!     Clients render that snapshot; they do not reconstruct Work dashboard
//!     truth from raw registry/control/policy internals.
//!
//! ## Submodules
//!
