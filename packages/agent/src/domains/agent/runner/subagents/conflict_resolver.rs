...
//!
//! [`abort_merge_with_reason`]: crate::domains::worktree::WorktreeCoordinator::abort_merge_with_reason
...
fn conflict_kind_label(kind: &crate::domains::worktree::types::ConflictKind) -> &'static str {
...
fn schedule_auto_abort_watcher(
    ...
    drop(tokio::spawn(async move {
        ...
        match coord.reconcile_completed_merge(&parent_session_id).await {
            ...
            Err(crate::domains::worktree::errors::WorktreeError::NoPendingMerge) => {
