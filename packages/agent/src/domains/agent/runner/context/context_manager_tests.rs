use super::*;
use crate::domains::agent::runner::context::types::CompactionConfig;

fn profile_context_policy(
    provider: crate::shared::messages::Provider,
...
fn cloud_context_policy() -> crate::domains::agent::runner::context::local_policy::ContextPolicy {
    profile_context_policy(crate::shared::messages::Provider::Anthropic)
}

fn local_context_policy() -> crate::domains::agent::runner::context::local_policy::ContextPolicy {
    profile_context_policy(crate::shared::messages::Provider::Ollama)
}
...
fn make_discovered(
    ...
    is_global: bool,
    content: &str,
) -> crate::domains::agent::runner::context::rules_discovery::DiscoveredRulesFile {
    crate::domains::agent::runner::context::rules_discovery::DiscoveredRulesFile {
...
/// compaction (see [`crate::domains::agent::runner::memory`] for why that would be bad).
#[tokio::test]
