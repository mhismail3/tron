...
//! | `tool_executor` | Execute tool calls with policy/hooks/cancellation, then route actual execution through canonical engine functions; production fails closed if the live catalog target is unavailable |
