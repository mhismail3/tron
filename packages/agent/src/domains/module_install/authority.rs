...
use super::Deps;
use super::{
    MODULE_INSTALL_DECISION_KIND, MODULE_INSTALL_REQUEST_KIND,
...
pub(super) async fn ensure_write_authority(
    ...
    require_kind_selectors(&grant, operation)?;
...
fn require_kind_selectors(grant: &EngineGrant, operation: &str) -> Result<(), CapabilityError> {
    ...
    for kind in [MODULE_INSTALL_REQUEST_KIND, MODULE_INSTALL_DECISION_KIND] {
