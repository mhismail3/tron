    ...
    let result = ctx
        ...
        .invoke(Invocation::new_sync(
            ...
            json!({
                ...
                "allowedAuthorityScopes": ["capability.execute", "filesystem.read", "filesystem.write", "resource.read", "resource.write"],
                "allowedResourceKinds": ["patch_proposal", "materialized_file"],
