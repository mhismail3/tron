...
//! trace/replay refs, and lifecycle events. It records metadata about existing
//! local composer transcription output only; raw audio is never returned to
//! providers by these operations.
//!
//! ## Submodules
//!
//! | Module | Purpose |
...
//! transcription providers, and do not expose provider-visible raw audio. Media
