...
use crate::domains::skills::loader;
use crate::domains::skills::types::{SkillInfo, SkillMetadata, SkillSource};
...
impl SkillFingerprint {
    ...
    pub fn compute(working_dir: &str) -> Self {
        Self::compute_for_home(&crate::shared::paths::home_dir(), working_dir)
    }
    ...
    fn scan_dir(dir: &Path, entries: &mut BTreeMap<String, u64>) {
        ...
        for entry in read_dir.flatten() {
            ...
            let skill_md = path.join(crate::domains::skills::constants::SKILL_MD_FILENAME);
...
mod tests {
    use super::*;
    use crate::domains::skills::types::SkillFrontmatter;
