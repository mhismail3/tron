...
struct MockRunner {
    handler: Box<
        dyn Fn(&str) -> crate::domains::tools::implementations::traits::ProcessOutput + Send + Sync,
    >,
}
...
impl MockRunner {
    fn ok(stdout: &str) -> Self {
        ...
        Self {
            handler: Box::new(move |_| {
                crate::domains::tools::implementations::traits::ProcessOutput {
                    stdout: s.clone(),
                    stderr: String::new(),
                    exit_code: 0,
                    duration_ms: 10,
    ...
    fn with_timeout() -> Self {
        Self {
            handler: Box::new(
                |_| crate::domains::tools::implementations::traits::ProcessOutput {
                    stdout: String::new(),
                    stderr: String::new(),
                    exit_code: 124,
                    duration_ms: 120_000,
...
impl ProcessRunner for MockRunner {
    ...
    ) -> Result<crate::domains::tools::implementations::traits::ProcessOutput, ToolError> {
