...
use crate::domains::tools::implementations::search::ast_search;
use crate::domains::tools::implementations::search::text_search;
use crate::domains::tools::implementations::traits::{ProcessRunner, ToolContext, TronTool};
use crate::domains::tools::implementations::utils::path::resolve_path;
        ...
        if use_ast {
            ...
            Ok(TronToolResult {
                content: ToolResultBody::Blocks(vec![
                    crate::shared::content::ToolResultContent::text(result.output),
                ]),
                details: Some(json!({
                    "mode": "ast",
            ...
            match result {
                Ok(r) => Ok(TronToolResult {
                    content: ToolResultBody::Blocks(vec![
                        crate::shared::content::ToolResultContent::text(r.output),
                    ]),
                    details: Some(json!({
                        "mode": "text",
...
mod tests {
    use super::*;
    use crate::domains::tools::implementations::testutil::extract_text;
    use crate::domains::tools::implementations::traits::ProcessOutput;
    ...
    impl ProcessRunner for MockRunner {
        async fn run_command(
            &self,
            command: &str,
            _opts: &crate::domains::tools::implementations::traits::ProcessOptions,
