...
use crate::domains::cron::scheduler;
...
pub(crate) async fn cron_scheduled_fire_value(
    ...
    .await;
    match outcome {
        crate::domains::cron::scheduler::CronScheduledFireOutcome::Started {
            job_id,
            next_run_at,
        } => Ok(json!({
            "started": true,
        ...
        crate::domains::cron::scheduler::CronScheduledFireOutcome::SkippedOverlap {
            job_id,
            next_run_at,
        } => Ok(json!({
            "started": false,
