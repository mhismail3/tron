...
pub fn generate_capability_instruction_text(capabilities: &[ModelCapability]) -> String {
    ...
    format!(
        ...
        `web_fetch`, `web_robots_check`, `web_source_list`, `web_source_inspect`, `web_source_archive`, `tool_source_list`, `tool_source_inspect`, `worker_package_list`, `worker_package_inspect`, `trace_list`, `trace_get`, `log_recent`, `replay_manifest`, \
