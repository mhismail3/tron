...
impl WorktreeCoordinator {
    ...
    pub async fn delete_session_branch(
        ...
        repo_root: &Path,
        branch: &str,
    ) -> Result<crate::domains::worktree::types::DeleteBranchResult> {
        use crate::domains::worktree::types::DeleteBranchResult;
    ...
    pub async fn prune_session_branches(
        &self,
        repo_root: &Path,
    ) -> Result<crate::domains::worktree::types::PruneBranchesResult> {
        use crate::domains::worktree::types::{PruneBranchesResult, PruneFailure};
