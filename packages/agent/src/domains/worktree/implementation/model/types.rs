...
pub use crate::domains::settings::types::IsolationMode;
...
impl WorktreeConfig {
    ...
    pub fn from_settings(session: &crate::domains::settings::types::SessionSettings) -> Self {
    ...
    pub fn from_settings_with_git(
        session: &crate::domains::settings::types::SessionSettings,
        git: &crate::domains::settings::types::GitWorkflowSettings,
    ) -> Self {
...
mod tests {
    ...
    fn config_from_settings() {
        let mut session = crate::domains::settings::types::SessionSettings::default();
