...
impl MergeOperation {
    ...
    pub(crate) async fn run(
        ...
        let strategy = match strategy_str.as_deref() {
            Some("rebase") => crate::domains::worktree::MergeStrategy::Rebase,
            Some("squash") => crate::domains::worktree::MergeStrategy::Squash,
            _ => crate::domains::worktree::MergeStrategy::Merge,
        };
