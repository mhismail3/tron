...
impl WorkerRuntime {
    ...
    pub(crate) fn project_run_graph(&self, requested: &InvocationRecord) -> Result<Value, String> {
        ...
        Ok(json!({
            ...
            "requestedModel":root.requested_model,
            "requestedReasoningLevel":root.requested_reasoning_level,
            "effectiveModel":root.effective_model,
            "effectiveReasoningLevel":root.effective_reasoning_level,
...
fn invocation_node(
    ...
    json!({
        ...
        "requestedReasoningLevel":record.requested_reasoning_level,
        "effectiveModel":record.effective_model,
        "effectiveReasoningLevel":record.effective_reasoning_level,
