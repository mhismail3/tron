...
vi.mock('../../src/gateway/rpc/adapters/agent.adapter.js', () => ({
...
vi.mock('../../src/gateway/rpc/adapters/memory.adapter.js', () => ({
...
vi.mock('../../src/gateway/rpc/adapters/transcription.adapter.js', () => ({
...
vi.mock('../../src/gateway/rpc/adapters/event-store.adapter.js', () => ({
...
vi.mock('../../src/gateway/rpc/adapters/worktree.adapter.js', () => ({
...
vi.mock('../../src/gateway/rpc/adapters/context.adapter.js', () => ({
...
vi.mock('../../src/gateway/rpc/adapters/browser.adapter.js', () => ({
...
vi.mock('../../src/gateway/rpc/adapters/skill.adapter.js', () => ({
...
import { createSessionAdapter } from '../../src/gateway/rpc/adapters/session.adapter.js';
import { createAgentAdapter } from '../../src/gateway/rpc/adapters/agent.adapter.js';
import { createMemoryAdapter } from '../../src/gateway/rpc/adapters/memory.adapter.js';
import { createTranscriptionAdapter } from '../../src/gateway/rpc/adapters/transcription.adapter.js';
import { createEventStoreAdapter } from '../../src/gateway/rpc/adapters/event-store.adapter.js';
import { createWorktreeAdapter } from '../../src/gateway/rpc/adapters/worktree.adapter.js';
import { createContextAdapter } from '../../src/gateway/rpc/adapters/context.adapter.js';
import { createBrowserAdapter } from '../../src/gateway/rpc/adapters/browser.adapter.js';
import { createSkillAdapter } from '../../src/gateway/rpc/adapters/skill.adapter.js';
