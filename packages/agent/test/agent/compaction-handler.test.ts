...
import { AgentCompactionHandler, createCompactionHandler } from '../../src/agent/compaction-handler.js';
import { createEventEmitter } from '../../src/agent/event-emitter.js';
import type { ContextManager, CompactionResult } from '../../src/context/context-manager.js';
import type { Summarizer } from '../../src/context/summarizer.js';
