...
use crate::tools::traits::{EventStoreQuery, ToolContext, TronTool};
...
fn format_entries(entries: &[crate::tools::traits::MemoryEntry]) -> String {
    if entries.is_empty() {
...
fn format_sessions(sessions: &[crate::tools::traits::SessionInfo]) -> String {
...
async fn dispatch_action(
    ...
    Ok(TronToolResult {
        content: ToolResultBody::Blocks(vec![crate::core::content::ToolResultContent::text(content)]),
...
mod tests {
    ...
    use crate::tools::traits::{MemoryEntry, SessionInfo};
