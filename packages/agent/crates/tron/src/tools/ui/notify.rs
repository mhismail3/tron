...
- Send notifications as events happen, don't batch them",
    ...
    async fn execute(&self, params: Value, ctx: &ToolContext) -> Result<TronToolResult, ToolError> {
        ...
        let title = crate::core::text::truncate_with_suffix(&title, MAX_TITLE_LENGTH, "...");
        let body = crate::core::text::truncate_with_suffix(&body, MAX_BODY_LENGTH, "...");
...
mod tests {
    ...
    use crate::tools::traits::NotifyResult;
