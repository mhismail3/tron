...
use crate::tools::traits::{SubagentSpawner, ToolContext, TronTool, WaitMode};
            ...
            Ok(results) => {
                ...
                Ok(TronToolResult {
                    content: ToolResultBody::Blocks(vec![
                        crate::core::content::ToolResultContent::text(summary),
                    ]),
                    details: Some(json!({
                        "mode": mode,
                        "results": details,
...
mod tests {
    ...
    use crate::tools::traits::{SubagentConfig, SubagentHandle, SubagentResult};
