...
mod tests {
    ...
    async fn multi_turn_with_tools() {
        ...
        let turn1_events = vec![
            ...
            StreamEvent::ToolCallEnd {
                tool_call: crate::core::messages::ToolCall::new("tc-1", "read", Map::new()),
            },
            StreamEvent::Done {
                message: AssistantMessage {
                    content: vec![
    ...
    async fn max_turns_limit() {
        ...
        let turn1 = vec![
            ...
            StreamEvent::ToolCallEnd {
                tool_call: crate::core::messages::ToolCall::new("tc-1", "echo", Map::new()),
            },
            StreamEvent::Done {
                message: AssistantMessage {
        ...
        async fn execute(
            ...
            tokio::select! {
                ...
                () = ctx.cancellation.cancelled() => {
                    return Ok(crate::core::tools::error_result("cancelled"));
                }
            }
            Ok(text_result(self.response, false))
        }
    ...
    fn make_tool_call_events(tool_calls: &[(&str, &str)]) -> Vec<StreamEvent> {
        ...
        for &(id, name) in tool_calls {
            ...
            events.push(StreamEvent::ToolCallEnd {
                tool_call: crate::core::messages::ToolCall::new(id, name, Map::new()),
            });
