...
use crate::core::tools::TronToolResult;
...
// `crate::core::messages::TokenUsage` — all extra fields are `Option` with
// `skip_serializing_if`, so the wire format is identical when unset.

/// Backward-compatible alias for turn-end events.
pub type TurnTokenUsage = crate::core::messages::TokenUsage;
/// Backward-compatible alias for response-complete events.
pub type ResponseTokenUsage = crate::core::messages::TokenUsage;
...
pub struct AssistantMessage {
    ...
    pub content: Vec<crate::core::content::AssistantContent>,
    /// Token usage.
    #[serde(skip_serializing_if = "Option::is_none")]
...
mod tests {
    ...
    fn stream_event_done() {
        let msg = AssistantMessage {
            content: vec![crate::core::content::AssistantContent::text("response")],
            token_usage: None,
        };
