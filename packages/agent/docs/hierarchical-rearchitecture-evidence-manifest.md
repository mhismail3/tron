...
- HRA-10 Session, HRA-11 UI, and HRA-12 App/Support source moves are closed by
  later checkpoints.
- HRA-13 still owns iOS test hierarchy mirroring and SourceGuard decomposition.
