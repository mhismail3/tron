...
- Hard LOC targets for tracked Rust and Swift source/test files are met.
- Broad fallback/compatibility/no-op wording still requires final source/docs triage in TPC-10.
