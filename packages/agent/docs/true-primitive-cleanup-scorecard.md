...
| TPC-1 | Retention inventory | 8 | passed_after_fix | architecture | Added the retention inventory and TSV, then regenerated it after TPC-2 through TPC-11 and the TMB closeout. Current coverage is 1,430 tracked and newly introduced source/docs/script paths in TPC scope: 105 `primitive`, 487 `implementation`, 380 `support`, 422 `test`, 36 `docs`, and 0 `delete`. Checkpoint commit: `92521b511`. | No unclassified tracked source remains. | TPC-1 inventory checkpoint |
