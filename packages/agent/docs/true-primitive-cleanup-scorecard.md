...
| TPC-1 | Retention inventory | 8 | passed_after_fix | architecture | Added the retention inventory and TSV, then regenerated it after TPC-2 through TPC-11, TMB closeout, and Phase 2 Slice 3 memory foundation. Current coverage is 1,704 tracked and newly introduced source/docs/script paths in TPC scope: 107 `primitive`, 571 `implementation`, 385 `support`, 511 `test`, 130 `docs`, and 0 `delete`. Checkpoint commit: `92521b511`. | No unclassified tracked source remains. | TPC-1 inventory checkpoint |
