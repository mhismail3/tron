...
- Hard LOC targets outside completed TPC-2/TPC-3/TPC-4/TPC-5/TPC-6/TPC-7/TPC-8 areas are not yet met.
- Broad fallback/compatibility/no-op wording still requires script and docs triage.
