...
All commands were run from `/Users/<USER>/Downloads/projects/tron` on
...
| Settings UI parity | `rg -n "SettingsPage\|SettingsState\|ServerSettings" packages/ios-app/Sources/UI/Settings packages/ios-app/Sources/Session/Chat/State/SettingsState.swift packages/ios-app/Sources/Engine/Protocol/Settings/EngineProtocolTypes+Settings.swift` | 0 |
