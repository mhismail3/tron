...
TPROD-J is active. The next required proof is three polished local example
packs: a Tron maintainer pack, an everyday local automation pack, and a
creative/knowledge pack, all local-only with tests, docs, no remote discovery,
and no personal-info literals.
