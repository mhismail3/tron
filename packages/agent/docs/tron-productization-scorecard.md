...
TPROD-F is active. The next required proof is a plain-language trust,
promotion, revocation, and cleanup UX slice backed by real source approval,
signature, conformance, promotion, revocation, and cleanup evidence without
client-owned trust or policy construction.
