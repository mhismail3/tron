...
| PAC-1 | Mac generated-project CI policy | 10 | passed_after_fix | CI/project generation | `tracked_ignored_files_stay_absent` owns ignored and untracked XcodeGen output for both clients. Mac and iOS workflows generate their projects and consume them through build, test, or archive operations. | Closed; focused Mac guard/source organization remains PAC-4/PAC-5. |
