...
5. PET-5/PET-7: PET-5 is closed in the storage/event checkpoint after fresh DB
   proof and no deleted product migration requirements remain. PET-7 is closed in
