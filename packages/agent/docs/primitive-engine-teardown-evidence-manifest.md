...
Residual risk: the public catalog/worker read primitives still return
catalog-revision fields. PET-11 continues with those readouts after this
control surface deletion.
