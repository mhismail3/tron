...
retained/successor iOS `Attachments`, `Process`, `SessionTree`, repo/task
...
loop only. PET-11 still owns retained/successor iOS `Attachments`, `Process`,
`SessionTree`, repo/task DTOs, retained `capability_support` host
