...
| `packages/agent/src/domains/capability/pool.rs` | capability pool owner | Rust hard limit 900 LOC | 1125 LOC | Snapshot inventory/parity tests are retired; split agent guidance and cockpit projection metadata behind the typed pool contract before adding a classification axis. | accepted_budget |
