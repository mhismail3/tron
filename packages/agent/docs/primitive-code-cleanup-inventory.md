...
Last updated: 2026-06-11 during `OPSAA-6` cleanup inventory refresh.
...
|----------------|-------|---------------|
| `retain` | 1486 | Current package/config/test/doc boundaries |
| `asset` | 70 | iOS/Mac resources and benchmark baselines |
| `generated` | 7 | XcodeGen, Cargo, and package-manager outputs |
| **Total** | **1563** | Whole repo plus retained inventory artifacts |
