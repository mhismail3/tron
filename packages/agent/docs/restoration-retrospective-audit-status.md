...
- Consolidation update: `codex/restoration-mainline-consolidation` starts from
  ...
  `019efad9-68bb-7ab0-9933-df140600ebed`.
...
- Slices 6A through 6E, Slice 7A, and Slices 8A through 8E are accepted on main
...
the accepted retrospective source/fix/closeout commits through Slice 8E. Before
