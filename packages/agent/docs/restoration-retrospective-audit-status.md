...
- Slices 6A through 6E, Slice 7A, and Slices 8A through 8D are accepted on main
...
the accepted retrospective source/fix/closeout commits through Slice 8D. Before
