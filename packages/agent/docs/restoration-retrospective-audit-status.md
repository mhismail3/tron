...
- Consolidation update: `codex/restoration-mainline-consolidation` starts from
  ...
  2026-06-24 fresh-implementation order; the current implementation candidate
  is `codex/phase-2-slice-6a-readonly-git-worktree`.
