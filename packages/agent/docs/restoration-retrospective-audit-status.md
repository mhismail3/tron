...
- Slices 6A through 6E, Slice 7A, Slice 8A, and Slice 8B are accepted on main after
...
the accepted retrospective source/fix/closeout commits through Slice 8B. Before
