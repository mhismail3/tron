...
| 29 | Phase 2 Slice 8C: Web HTML/Text Extraction And Citation Quality Foundation | Phase 2 agent-execution restoration | Baseline `origin/main@5c99501b5e00305f3be95ae3fce4d2f855c6aed8`; implementation branch `codex/phase-2-slice-8c-web-html-text-extraction`; implementation commit pending until branch closeout. | Source handoff thread `019ef914-ed80-78f2-b253-229240d49444`; discovery thread `019efb81-9ae8-77a2-a7ff-b01af2271878`; implementation worktree `/Users/<USER>/.codex/worktrees/38b9/tron`. | `packages/agent/src/domains/web/extract.rs`; `packages/agent/src/domains/web/fetch.rs`; `packages/agent/src/domains/web/source.rs`; `packages/agent/src/domains/web/tests.rs`; `packages/agent/src/domains/web/web_extraction_tests.rs`; `packages/agent/src/domains/web/web_source_tests.rs`; `packages/agent/src/engine/durability/resources/web_definitions.rs`; Phase 2 scorecard/evidence/inventory; README capability docs; HRA/TMB/TPC/PCC/SACB/BPRC/IARM/DESI/public-protocol guards. | Implementation candidate adds dependency-free deterministic HTML/XHTML readable-text extraction before output bounding/redaction, removes script/style/noise text from HTML snippets, records extraction mode/extractor/title/extracted-byte/truncation metadata under `textEvidence`, preserves raw captured-byte SHA-256 provenance, surfaces extraction metadata in source list/inspect, and keeps old Slice 8A/8B `web_source` records inspectable. | Search providers, browser automation, crawling, sitemap traversal, robots policy, login/cookies/session reuse, credential reuse, shell/process network side channels, native iOS web/source UI, public `/engine` web APIs, network-enabled jobs, and specialized source UI remain deferred. | Pending review. Do not integrate until independent review accepts the implementation branch. |
