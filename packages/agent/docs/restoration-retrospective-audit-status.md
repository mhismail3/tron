...
- Consolidation update: `codex/restoration-mainline-consolidation` starts from
  ...
  `019ef942-3a15-74c0-8230-7065c4e0000d`.
...
- Distinguish real blockers from accepted deferred scope. Old legacy panels,
  PTY terminals, web, mutating git/worktree behavior, subagent, scheduler,
  native notification/native process UI, semantic memory engines, and risky
  default approval policies are not bugs merely because they remain absent.
