...
Status: CSD-10 `passed_after_fix`; 113 scheduling-surface rows and 13 static-gate/predecessor rows inventoried and classified.
...
Static-gate/predecessor rows: 13 `test_fixture` rows.
