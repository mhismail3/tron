...
| UXR-1 | Dashboard session cards and metadata icons | 10 | pending | Plain, forked, isolated worktree, dirty, forked+dirty, processing, long title/path, narrow phone, iPad/sidebar, tap/open, archive/delete/context actions. | Add/pass `SessionTitleIcons` pure rules and simulator screenshot proof. |
