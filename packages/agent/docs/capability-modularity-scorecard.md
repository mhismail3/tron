...
| `device` | 2 | Device token custody remains a trusted internal domain service; model-facing operations inspect redacted record-plane evidence only. |
