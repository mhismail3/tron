...
| `packages/agent/src/domains/agent/loop/capability_invocation_executor/grant_tests.rs` | 1284 | Capability runtime grant test owner | Accepted Slice 24E keeps procedural module-pack runtime-grant regressions with prior Slice 24D memory query/decision, execute-resource, and subagent delegated-grant tests; split restored resource-family, procedural, memory, and subagent delegated-grant fixtures into focused modules before adding more execute-resource families. | PCC-10/P3MSA-INV-011/P3MSA-INV-012/P3MSA-INV-013 |
