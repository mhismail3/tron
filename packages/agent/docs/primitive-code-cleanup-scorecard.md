...
|------|-------------|-------|--------|-------------|
| `packages/agent/src/engine/authority/grants/authorization.rs` | 1191 | Engine authority grants owner | Broad capability-invocation authorization scanner retained while Slice 23B adds module proposal read/write scopes, exact `module_proposal` kind and inspect-resource selectors, and wildcard denial; future authority slices should split per-domain scanner helpers before growing this file further. | PCC-10/P3MSA-S23B |
