...
|------|-------------|-------|--------|-------------|
| `packages/agent/src/engine/authority/grants/authorization.rs` | 2896 | Engine authority grants owner | Broad capability-invocation authorization scanner retained while accepted Slice 24D adds exact memory query/decision selectors alongside accepted Slice 24C delegated subagent task selectors and existing module-program-execution exact runtime/job selectors; future authority slices should split per-domain scanner helpers before growing this file further. | PCC-10/P3MSA-S23B/P3MSA-INV-009/P3MSA-INV-011/P3MSA-INV-012 |
| `packages/agent/src/domains/agent/loop/capability_invocation_executor/grant.rs` | 1327 | Capability runtime grant owner | Runtime capability grant derivation retained while accepted Slice 24D derives exact memory query/decision selectors and accepted Slice 24C derives delegated subagent task selectors under `capability::execute`; future grant slices should split per-domain grant policies before growing this file further. | PCC-10/SACB-10/P3MSA-INV-009/P3MSA-INV-011/P3MSA-INV-012 |
| `packages/agent/src/domains/agent/loop/capability_invocation_executor/grant_tests.rs` | 1136 | Capability runtime grant test owner | Accepted Slice 24D keeps memory query/decision runtime-grant regressions with existing execute-resource and subagent delegated-grant tests; split restored resource-family, memory, and subagent delegated-grant fixtures into focused modules before adding more execute-resource families. | PCC-10/P3MSA-INV-011/P3MSA-INV-012 |
