...
| PCC-1 | Inventory and folder justification | 12 | pending | architecture | `git ls-files`, LOC counts, module docs, manifests, source trees, and current scorecards classify every tracked file as retain/collapse/delete/generated/asset and produce the target tree. | Unknown folders may lack real boundaries. | pending |
...
PCC-1 starts the exhaustive inventory and target-tree proof. Begin with tracked
file inventory and ownership classification:
