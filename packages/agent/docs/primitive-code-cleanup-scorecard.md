...
| `packages/agent/src/domains/capability/pool.rs` | 1125 | Capability pool classification owner | Operation and live catalog classifications remain one typed owner consumed by catalog and cockpit views; split agent guidance and projection helpers behind that contract before adding another classification dimension. | PCC-10/capability-pool |
