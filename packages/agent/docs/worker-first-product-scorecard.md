...
Continue with JARVIS-11 soak, visual QA, and closeout. Keep JARVIS-0
visual-baseline debt open until the final closeout records the baseline and
current visual artifacts together with a clean queue/approval/worker state.
