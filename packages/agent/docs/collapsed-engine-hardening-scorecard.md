...
|---|---:|---|---|---:|
| `packages/agent/tests/threat_model_invariants.rs` | 6,925 | intentional exception | cross-cutting static architecture gates | 7,050 |
...
| `packages/agent/src/domains/auth/provider_credentials/storage/tests.rs` | 1,383 | intentional exception | credential storage scenario matrix | 1,425 |
...
| `packages/agent/src/domains/skills/implementation/runtime/tracker/tests.rs` | 1,301 | intentional exception | skill runtime tracker scenario matrix | 1,350 |
