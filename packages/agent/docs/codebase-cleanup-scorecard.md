...
- CLC-2 resource, resource-store, queue, approval, engine-type, generated-UI,
  control, ledger, grant, primitive-runtime, and engine-registry
  ...
  catalog-change recording stay out of the live-catalog root.
