...
| `packages/agent/tests/integration.rs` | 1252 | CLC-9 harnesses | Integration harness module map and shared test setup stay together while the scenario bodies live under `tests/integration/`. | 1300 | CLC-9 |
