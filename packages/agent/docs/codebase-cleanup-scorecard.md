...
- CLC-2 resource, resource-store, queue, approval, engine-type, generated-UI,
  ...
  catalogs, and function registrations stay out of the lifecycle root; trust-audit schedule
...
|------|-------------|-------|--------|--------|--------------------------|
| `packages/agent/tests/threat_model_invariants.rs` | 6090 | CLC-9 static gates | Cross-cutting architecture gates and cleanup scorecard enforcement, including CLC-1 and CLC-2 split-boundary gates plus full source-trust, manifest, grant, resource, schema, payload, and action-catalog subtree checks. | 6150 | CLC-9 |
