...
- CLC-2 resource, resource-store, queue, approval, engine-type, generated-UI,
  control, ledger, grant, and primitive-runtime
...
- Split the next engine-fabric hotspots by ownership boundary:
  ...
  `registry.rs`, `primitives/ui/authoring/mod.rs`, and generated-UI files where the audit finds a direct
  simplification path.
