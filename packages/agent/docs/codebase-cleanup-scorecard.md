...
| `packages/agent/src/domains/capability/operations/mod.rs` | 1107 | CLC-1 capability operations | Capability operation orchestration keeps validation, lifecycle, and projection together until a narrower operation boundary appears. | 1150 | CLC-1 |
