...
| `packages/ios-app/Tests/ViewModels/EngineConsoleStateTests.swift` | 1019 | CLC-9 iOS tests | Engine console state matrix spans connection, invocation, and generated UI state transitions after the Created by Agent projection cases moved into their own focused suite. | 1100 | CLC-9 |
