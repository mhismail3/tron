...
Current manual-test substrate confidence: **88/100**.
...
| Worker/function/trigger substrate | 12 | 11 | Engine tests cover primitive contracts; live state, queue, and subagent paths now compose through `execute` with DB proof. | Stream subscribe/poll, trigger, local-process worker activation, and package disable/recovery. |
