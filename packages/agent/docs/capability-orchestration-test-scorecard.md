...
Current manual-test substrate confidence: **91/100**.
...
| Runtime resilience | 10 | 8 | Reconnect tests, queue/idempotency unit coverage, manual process retries, and truthful background auto-retain skip/failure reporting are covered. | Server restart during session, queue retry under live load, crash/partial-failure recovery, and activation cleanup under live use. |
