...
| `packages/ios-app/Tests/Session/WorkerLifecycle/AgentCockpitStateTests.swift` | 711 | worker lifecycle projection test owner | Keep capability-pool role and summary projection assertions here only; split future operation-detail or activity-state cases into focused cockpit projection test files. | over_limit_followup |
