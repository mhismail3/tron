...
| `packages/ios-app/Sources/Session/Chat/ViewModel/ChatViewModel.swift` | 642 | chat view-model owner | Move new observation, reconstruction, or lifecycle behavior into focused view-model extensions before expanding the root coordinator further. | watch |
