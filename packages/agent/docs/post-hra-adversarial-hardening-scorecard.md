...
| `packages/ios-app/Sources/UI/Chat/Sheets/ContextControlSheet.swift` | 604 | session briefing owner | Move additional context/model/audit presentation into focused Session Briefing subviews before expanding this sheet further. | watch |
