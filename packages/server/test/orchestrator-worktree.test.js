...
describe('EventStoreOrchestrator Worktree Integration', () => {
    ...
    describe('createSession', () => {
        it('should acquire working directory when creating session', async () => {
            ...
            expect(mockCoordinator.acquire).toHaveBeenCalledWith(sessionId, tempDir, {});
        });
    ...
    describe('forkSession', () => {
        it('should create worktree branched from fork point', async () => {
            ...
            expect(mockCoordinator.acquire).toHaveBeenCalledWith('sess_fork', tempDir, expect.objectContaining({
                parentSessionId: 'sess_parent',
                parentCommit: 'parent_commit_hash',
            }));
    ...
    describe('endSession', () => {
        ...
        it('should handle release with merge option', async () => {
            ...
            expect(mockCoordinator.release).toHaveBeenCalledWith('sess_1', expect.objectContaining({
                mergeTo: 'main',
                mergeStrategy: 'squash',
            }));
        });
...
//# sourceMappingURL=orchestrator-worktree.test.js.map