...
import { createWorktreeCoordinator, } from '@tron/core';
// =============================================================================
// Test Helpers
// =============================================================================
...
describe('WorktreeCoordinator', () => {
    ...
    afterEach(async () => {
        ...
        for (const [sessionId] of coordinator.getActiveSessions()) {
            try {
                await coordinator.release(sessionId, { force: true });
            }
            catch {
    ...
    describe('acquire - parallel sessions', () => {
        it('should create isolated worktree for second session', async () => {
            const session1 = 'sess_first';
            const session2 = 'sess_second';
    ...
    describe('acquire - forked sessions', () => {
        it('should create worktree branched from parent commit', async () => {
            const parentSession = 'sess_parent';
            const childSession = 'sess_child';
        ...
        it('should include forkedFrom in acquired event', async () => {
            ...
            const childAcquiredEvent = mockEventStore.events.find(e => e.type === 'worktree.acquired' && e.sessionId === childSession);
    ...
    describe('getWorkingDirectory', () => {
        ...
        it('should return null for unknown session', () => {
            const workDir = coordinator.getWorkingDirectory('unknown');
...
//# sourceMappingURL=worktree-integration.test.js.map