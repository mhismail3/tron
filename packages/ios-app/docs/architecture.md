...
the current folder is listed as a plain left-aligned path, navigation actions
are separate compact single-line controls, and existing server directories own
the main list. It browses
