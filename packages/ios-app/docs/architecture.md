...
navigation actions are separate compact single-line capsule controls, the
current folder is listed as a plain left-aligned path, and existing server
directories own the main list. It browses
