...
| `Views/EngineConsole/EngineConsoleHarnessChangeView.swift` | Native Harness Changes card for session-created capability provenance/test/surface/promotion/cleanup/trace evidence |
