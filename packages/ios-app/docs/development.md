...
post-reveal marker/geometry evidence settles the opening target and the exact release callback is consumed.
The external presentation remains in a noninteractive revealing phase through that proof; missing proof
