...
o placeholder or correctly installed underflow marker may arm physical repair, and covering the viewport
...
skill/prompt chips use the same measured composer-to-transcript flight as photo/file chips, while Reduce Motion and
