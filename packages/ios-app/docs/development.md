...
retain their canonical target. Date values use localized standard action pills and open the native date
picker for editing. The dashboard cards and detail sheet use the same inline navigation, settings
