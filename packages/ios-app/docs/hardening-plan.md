...
2. Implement Phase 6.3 bounded deduplicated media/image loading, then physically calibrate it together with the completed Phase 6.2 cache before tightening provisional limits. Keep incremental-prefix Markdown parsing deferred until differential tests prove exact cold equality.
