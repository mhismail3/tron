...
- `PairingURLParser` - Parses `tron://pair?host=…&port=…&token=…[&label=…]` into a typed struct. Powers both QR scan and universal-paste auto-fill in the onboarding pairing form.
