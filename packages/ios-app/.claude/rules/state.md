...
| `OnboardingState` | `@Observable` onboarding-sheet state. Owns the three-page sheet selection, pairing form inputs, and `complete()` which flips `@AppStorage("onboardingComplete")`. |
