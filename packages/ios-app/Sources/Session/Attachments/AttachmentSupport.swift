...
struct AttachmentSupport: Equatable {
    ...
    /// Derive tool from the server-owned model attachment policy.
    static func from(model: ModelInfo?) -> AttachmentSupport {
    ...
    static let `default` = AttachmentSupport(
        supportsImages: true,
