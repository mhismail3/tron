...
struct SessionSidebar: View {
    ...
    var body: some View {
                    ...
                    Section {
                        ForEach(filteredSessions) { session in
                            CachedSessionSidebarRow(
                                ...
                                streamManager: eventStoreManager.sessionActivityStreamManager
                            )
                            .tag(session.id)
        ...
        .toolbar {
            ShellToolbarContent(title: eventStoreManager.sortedSessions.isEmpty ? "Tron" : "Sessions", accent: .tronEmerald, actions: actions)
        }
    }
...
struct CachedSessionSidebarRow: View {
    ...
    let isSelected: Bool
    let streamManager: SessionActivityStreamManager
