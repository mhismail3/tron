...
// MARK: - Session Activity Updates

/// Protocol for contexts that can update session activity summaries.
@MainActor
protocol SessionActivityUpdating: AnyObject {
    /// Update session activity summary in the database.
