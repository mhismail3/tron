...
struct GatewayProtocolContractTests {
    ...
    func summaryUpdateDecodes() throws {
        let data = Data(#"{"sessionId":"session-1","summaryRevision":7,"phase":"running","updatedAt":"2026-01-01T00:00:01Z","activeSince":"2026-01-01T00:00:00Z","messageCount":2,"firstMessage":"hello","completionRevision":3,"attentionRevision":4,"isUnread":true}"#.utf8)
