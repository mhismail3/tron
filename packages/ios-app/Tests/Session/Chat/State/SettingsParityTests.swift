...
final class SettingsParityTests: XCTestCase {
    ...
    func testEveryDecodedSettingsFieldProjectsIntoSnapshot() throws {
        let json = #"{"autonomousWorkers":true,"server":{"defaultWorkspace":"/parity-workspace","tailscaleIp":"100.64.0.7"},"context":{"compactor":{"preserveRecentCount":7,"triggerTokenThreshold":0.55}}}"#
        ...
        XCTAssertEqual(
            ...
            Set(["autonomousWorkers", "defaultModel", "defaultWorkspace", "tailscaleIp", "compaction"])
        )
        XCTAssertEqual(
