...
struct PresentationStyleGuardTests {
    ...
    func chatScopedMotionOwnership() throws {
        ...
        #expect(!structural.contains("resourcePanelDuration"))
    ...
    func compactToolAndNoticePresentation() throws {
        ...
        #expect(scrollCoordinator.contains("persistent bottom position owns growth"))
        ...
        #expect(transcriptView.contains(".defaultScrollAnchor(.top, for: .alignment)"))
        ...
        #expect(chat.occurrences(of: "position.scrollTo(id: \"transcript-bottom\", anchor: .bottom)") == 1)
        ...
        #expect(chat.contains("transcriptScrollPosition.scrollTo(id: \"transcript-bottom\", anchor: .bottom)"))
        #expect(!chat.contains("scrollTo(edge: .bottom)"))
    ...
    func composerResourcePickerPresentation() throws {
        ...
        #expect(composer.contains("ChatComposerStructuralHost(onHeightChange: onComposerHeight)"))
