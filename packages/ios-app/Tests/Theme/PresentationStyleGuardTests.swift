...
struct PresentationStyleGuardTests {
    ...
    func removedProvisionalChatSurfaces() throws {
        ...
        #expect(processSheets.contains("ProcessActivityOrb(mode: orbMode, size: 36)"))
    ...
    func compactToolAndNoticePresentation() throws {
        ...
        #expect(scrollCoordinator.contains("Native size-change anchoring owns pinned growth"))
        ...
        #expect(transcriptView.contains("isReady && scrollCoordinator.usesBottomSizeChangeAnchor ? .bottom : .top"))
        #expect(transcriptView.contains(".defaultScrollAnchor(.top, for: .initialOffset)"))
