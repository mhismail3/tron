...
struct PresentationStyleGuardTests {
    ...
    func chatScopedMotionOwnership() throws {
        ...
        #expect(composer.contains("ChatComposerLayout(maximumHeight: maximumHeight"))
        #expect(structural.contains("let flexibleHeight = min("))
        #expect(structural.contains("var y = bounds.maxY - placedHeight"))
    ...
    func progressiveSettingsSheets() throws {
        ...
        #expect(settings.contains("TronGlassCard(accent: .tronEmerald)"))
    ...
    func sendToChatMotion() throws {
        ...
        #expect(motion.contains("struct ChatComposerLayout: Layout"))
        #expect(motion.contains("maximumHeight.isFinite"))
        ...
        #expect(motion.contains(".frame(maxHeight: maximumHeight, alignment: .bottom)"))
        #expect(motion.contains("return .move(edge: .bottom).combined(with: .opacity)"))
        #expect(!motion.contains(".clipped()"))
    ...
    func emeraldNavigationAndScrollEdges() throws {
        ...
        #expect(chat.contains(".onGeometryChange(for: CGSize.self)"))
        #expect(chat.contains("toolbarContainerWidth = size.width"))
    ...
    func serverFilterUsesMediumSheet() throws {
        ...
        #expect(shell.contains("DashboardServerFilterPreferences.loadSortMode()"))
        #expect(shell.contains("DashboardServerFilterPreferences.saveSortMode(mode)"))
    ...
    func compactToolAndNoticePresentation() throws {
        ...
        #expect(composerOwner.contains("maximumHeight: maximumHeight"))
        #expect(composerOwner.occurrences(of: ".chatFlexibleComposerSurface()") == 1)
        #expect(chat.contains("maximumHeight: availableChatHeight"))
    ...
    func composerResourcePickerPresentation() throws {
        ...
        #expect(composer.contains("ChatComposerLayout(maximumHeight: maximumHeight"))
        #expect(composer.occurrences(of: ".chatFlexibleComposerSurface()") == 1)
        #expect(chat.contains("maximumHeight: availableChatHeight"))
