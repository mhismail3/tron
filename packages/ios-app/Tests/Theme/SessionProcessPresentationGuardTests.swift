...
struct SessionProcessPresentationGuardTests {
    ...
    func processSurfaces() throws {
        ...
        let composer = try source("Sources/UI/Chat/ChatUIKitComposerController.swift")
        ...
        #expect(chat.contains("$0.kind == .subagent"))
        ...
        #expect(composer.contains("processButton"))
        #expect(composer.contains("processesPressed"))
