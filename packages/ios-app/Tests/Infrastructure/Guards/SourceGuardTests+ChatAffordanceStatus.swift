...
extension SourceGuardTests {
    ...
    func testSessionDashboardRowsUseInsetLiquidGlassContainers() throws {
        ...
        #expect(dashboard.contains("static let rowPressedBrightness: Double = 0.035"))
        ...
        #expect(dashboard.contains("ZStack(alignment: .leading)"))
        #expect(dashboard.contains("rowContainerSurface(isPressed: configuration.isPressed)"))
        #expect(dashboard.contains("configuration.label"))
        #expect(dashboard.contains("private func rowContainerSurface(isPressed: Bool) -> some View"))
        #expect(dashboard.contains(".sectionFill("))
        #expect(dashboard.contains("interactive: true"))
        #expect(dashboard.contains("subtle: !isSelected && !isPressed"))
        #expect(dashboard.contains(".brightness(isPressed ? SessionDashboardLayout.rowPressedBrightness : 0)"))
