...
| C-MAC-REDACT-URL-1 | Needs approval | Neither Mac redactor masks URL userinfo (`https://user:password@host`); add it to `DiagnosticsRedactor`, which widens both log and feedback redaction | C-MAC-REDACT-1 | |
