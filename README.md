...
14. `scripts/tron-release-notes` writes a full draft changelog from first-parent git history since the previous `server-v*` tag, including the DMG filename and SHA256.
