...
resource schema `tron.resource.module_install_request.v1` and payload schema
version `tron.module_install_request.v1`, and `module_install_decision` with
resource schema `tron.resource.module_install_decision.v1` and payload schema
version `tron.module_install_decision.v1`. Install request and decision
