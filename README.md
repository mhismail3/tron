...
Slice 24B adds the validated `jobs_program_execution_module` manifest for the
module-owned jobs/program-execution pack. It declares only
...
`file_git_module` operation pack plus the validated Slice 24B
